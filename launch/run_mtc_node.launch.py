...
from launch.actions import OpaqueFunction, IncludeLaunchDescription, RegisterEventHandler, TimerAction
...
def launch_setup(context, *args, **kwargs):
    ...
    # Fix: Use proper controller manager namespace (empty if ros_namespace is empty)
    cm_ns = '{}/controller_manager'.format(ros_namespace) if ros_namespace else 'controller_manager'
